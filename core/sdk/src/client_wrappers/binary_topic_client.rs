...
impl TopicClient for ClientWrapper {
    async fn get_topic(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.get_topic(stream_id, topic_id).await,
        }
    }
    ...
    async fn get_topics(&self, stream_id: &Identifier) -> Result<Vec<Topic>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_topics(stream_id).await,
        }
    }
    ...
    async fn delete_topic(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.delete_topic(stream_id, topic_id).await,
        }
    }
    ...
    async fn purge_topic(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.purge_topic(stream_id, topic_id).await,
        }
    }
}
