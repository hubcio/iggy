...
impl Client for ClientWrapper {
    async fn connect(&self) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.connect().await,
        }
    }
    ...
    async fn disconnect(&self) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.disconnect().await,
        }
    }
    ...
    async fn shutdown(&self) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.shutdown().await,
        }
    }
    ...
    async fn subscribe_events(&self) -> Receiver<DiagnosticEvent> {
        match self {
            ...
            ClientWrapper::New(client) => client.subscribe_events().await,
        }
    }
}
