...
impl UserClient for ClientWrapper {
    async fn get_user(&self, user_id: &Identifier) -> Result<Option<UserInfoDetails>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_user(user_id).await,
        }
    }
    ...
    async fn get_users(&self) -> Result<Vec<UserInfo>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_users().await,
        }
    }
    ...
    async fn delete_user(&self, user_id: &Identifier) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.delete_user(user_id).await,
        }
    }
    ...
    async fn update_user(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.update_user(user_id, username, status).await,
        }
    }
    ...
    async fn update_permissions(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.update_permissions(user_id, permissions).await,
        }
    }
    ...
    async fn login_user(&self, username: &str, password: &str) -> Result<IdentityInfo, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.login_user(username, password).await,
        }
    }
    ...
    async fn logout_user(&self) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.logout_user().await,
        }
    }
}
