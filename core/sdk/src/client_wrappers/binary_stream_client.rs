...
impl StreamClient for ClientWrapper {
    async fn get_stream(&self, stream_id: &Identifier) -> Result<Option<StreamDetails>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_stream(stream_id).await,
        }
    }
    ...
    async fn get_streams(&self) -> Result<Vec<Stream>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_streams().await,
        }
    }
    ...
    async fn create_stream(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.create_stream(name, stream_id).await,
        }
    }
    ...
    async fn update_stream(&self, stream_id: &Identifier, name: &str) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.update_stream(stream_id, name).await,
        }
    }
    ...
    async fn delete_stream(&self, stream_id: &Identifier) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.delete_stream(stream_id).await,
        }
    }
    ...
    async fn purge_stream(&self, stream_id: &Identifier) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.purge_stream(stream_id).await,
        }
    }
}
