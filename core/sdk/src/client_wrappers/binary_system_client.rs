...
impl SystemClient for ClientWrapper {
    async fn get_stats(&self) -> Result<Stats, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_stats().await,
        }
    }
    ...
    async fn get_me(&self) -> Result<ClientInfoDetails, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_me().await,
        }
    }
    ...
    async fn get_client(&self, client_id: u32) -> Result<Option<ClientInfoDetails>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_client(client_id).await,
        }
    }
    ...
    async fn get_clients(&self) -> Result<Vec<ClientInfo>, IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.get_clients().await,
        }
    }
    ...
    async fn ping(&self) -> Result<(), IggyError> {
        match self {
            ...
            ClientWrapper::New(client) => client.ping().await,
        }
    }
    ...
    async fn heartbeat_interval(&self) -> IggyDuration {
        match self {
            ...
            ClientWrapper::New(client) => client.heartbeat_interval().await,
        }
    }
    ...
    async fn snapshot(
        ...
        match self {
            ...
            ClientWrapper::New(client) => client.snapshot(compression, snapshot_types).await,
        }
    }
}
